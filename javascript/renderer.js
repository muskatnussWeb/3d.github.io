...
class Renderer{
    ...
    clear(){
        this.gl.clearColor(0.24, 0.16, 0.0, 1.0);
    ...
    render(){
        ...
        //this.renderItem(this.game.itemList[0]);
    }
    ...
    renderItem(item){
        ...
        this.gl.uniform1i(this.shaderProgram.programInfo.uniformLocation.gradient, item.gradient==true?1:0);
